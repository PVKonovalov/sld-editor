...
export const dictionary = {
  ...
  'file.dropHint': 'Or drop a .xml or .svg file anywhere in the app window.',
  'file.dropOverlay': 'Drop .xml or .svg file to load',
  'file.invalidDiagramFile': 'Not a .xml or .svg file: {{name}}',
