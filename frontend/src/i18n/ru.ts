...
export const dictionary: Record<keyof Dictionary, string> = {
  ...
  'file.dropHint': 'Либо перетащите файл .xml или .svg в любое место окна приложения.',
  'file.dropOverlay': 'Отпустите файл .xml или .svg для загрузки',
  'file.invalidDiagramFile': 'Не файл .xml или .svg: {{name}}',
